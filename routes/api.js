...
router.get('/ad', async function(req, res, next) {
        ...
        if(req_type !== 'display'){
            ...
            let query2 = `SELECT AD_ID, BS_NameKor, ADY_CD, ADY_Location, ADY_SlideDuration, AD_BC_ID, BC_NameKor, AD_PaymentStatus, AD_Title, AD_DtS, AD_DtF, AD_ContentURL 
            ...
            res.json({ data : result_data, data2 : result2.recordset });
        }
