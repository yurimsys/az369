...
const optionsForHTTPS = {
    ca : fs.readFileSync("./yurimsys12_az369/ssl_key/ca_bundle.crt"),
    key : fs.readFileSync('./yurimsys12_az369/ssl_key/private.key'),
    cert : fs.readFileSync('./yurimsys12_az369/ssl_key/certificate.crt')
